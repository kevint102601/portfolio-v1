...
const Contact = () => {
    return (
        <div class="max-w-[1200px] mx-auto bg-black sm:oy-20 p-5" id="contact">
            <div className='text-center'>
                <h2 className='text-4x1 font-bold leading-tight primary-color'>Contact Me</h2>
            </div>
            ...
            <div class="max-w-[800px] mx-auto">
                ...
                <div class="mt-6 bg-[#161616] rounded-x1">
                    <div class="p-10">
                        ...
                        <form action="https://getform.io/f/ebpdnrzb" method="POST">
